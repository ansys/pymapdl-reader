...
You can clone the source repository from `PyMAPDL-Reader
GitHub <https://https://github.com/pyansys/pymapdl-reader>`_
...
`PyMAPDL-Reader Issues <https://github.com/pyansys/pymapdl-reader/issues>`_ where the
community or PyMAPDL-Reader developers can collectively address your
...
report it at `PyMAPDL-Reader Issues <https://github.com/pyansys/pymapdl-reader/issues>`_
...
Feature Requests
----------------
We encourage users to submit ideas for improvements to PyMAPDL-Reader!
Please create an issue on the `PyMAPDL-Reader Issues <https://github.com/pyansys/pymapdl-reader/issues>`_
...
---------------------
If you have an idea for how to improve PyMAPDL-Reader, consider first
...
PyMAPDL-Reader repository. Please follow the practices outlined here when
...
1. Follow the `Zen of Python <https://www.python.org/dev/peps/pep-0020/>`__. As
   ...
   intuitive, novel, and helpful for PyMAPDL-Reader and its users.
...
Finally, please take a look at our `Code of Conduct <https://github.com/pyansys/pymapdl-reader/blob/master/CODE_OF_CONDUCT.md>`_


Contributing to PyMAPDL-Reader through GitHub
---------------------------------------------
To submit new code to PyMAPDL-Reader, first fork the `PyMAPDL-Reader GitHub Repo
<https://github.com/pyansys/pymapdl-reader>`_ and then clone the forked
...
`PyMAPDL-Reader <https://github.com/pyansys/pymapdl-reader>`_ and target your
...
- Docstrings from the classes, functions, and modules of ``ansys.mapdl.reader`` using `sphinx.ext.autodoc <https://www.sphinx-doc.org/en/master/usage/extensions/autodoc.html>`_.
...
----------------------------------------------
The PyMAPDL-Reader project uses continuous integration and delivery (CI/CD)
...
- There will be one or many `release/` branches based on minor
  ...
  for past versions of ``ansys.mapdl.reader`` without having to worry about
  untested features.
...
functionality and stability of ``PyMAPDL-Reader``.  Before a minor release is
...
6. It is now the responsibility of the PyMAPDL-Reader community and
...
8. Create a list of all changes for the release. It is often helpful
   ...
   <https://github.com/pyansys/pymapdl-reader/compare>`_ to see the
...
9. Place your release notes from step 8 in the description within
   `PyMAPDL-Reader Releases <https://github.com/pyansys/pymapdl-reader/releases/new>`_
...
2. Update `__version__.py` with the next patch increment
   ...
   release branch.  This gives the PyMAPDL-Reader developers and community
